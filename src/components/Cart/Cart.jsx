...
const Cart = ({ cart, handleRemoveFromCart }) => {
    ...
    return (
        <div>
            <h2 className={cart.length == 1 ? 'blue' : 'green'}>order summery: {cart.length}</h2>
            <p className={`bold borderd ${cart.length === 3 ? 'orange' : 'red'}`}>something</p>
            {
                cart.length > 2
            ...
            {
                cart.length === 2 && <p>Double Bonanaza!!!</p>
            }
            {
